...
public class GuiTfStorage extends GuiTfMachineBase
{
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        ...
        String s = StatCollector.translateToLocal(this.machineInventory.getInvName());
        this.fontRenderer.drawString(s, this.xSize / 2 - this.fontRenderer.getStringWidth(s) / 2, 6, 0x5c5e54);
        this.fontRenderer.drawString(StatCollector.translateToLocal("container.inventory"), 8, this.ySize - 96 + 3, 0x5c5e54);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        if (this.isPointInRegion(101, 36, 59, 12, par2, par3))
        {
            this.drawTfHoveringTipFixedSize(par2, par3, 51, 22, HoverTextPosition.LOWER_CENTER, new IHoverDrawingHandler()
            {
                ...
                public void draw(int ox, int oy, int fw, int fh)
                {
                    ...
                    fontRenderer.drawString(s, ox + 33 - fontRenderer.getStringWidth(s), oy + 2, 0xf1f2e6);
                    
                    s = String.format("/%.0f", machineInventory.tfCapacity);
                    fontRenderer.drawString(s, ox + 41 - fontRenderer.getStringWidth(s), oy + 12, 0xb4b5aa);
