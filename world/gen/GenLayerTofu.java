...
public abstract class GenLayerTofu
{
    /** seed from World#getWorldSeed that is used in the LCG prng */
    private long worldGenSeed;

    /** parent GenLayer that was provided via the constructor */
    protected GenLayerTofu parent;
     ...
     * first.
     */
    public static GenLayerTofu initializeAllBiomeGenerators(long par0, WorldType par2WorldType)
    {
        ...
        GenLayerBiome genlayerbiome = new GenLayerBiome(200L, genlayerfuzzyzoom, par2WorldType);
        GenLayerTofu genlayer1 = GenLayerZoom.func_75915_a(1000L, genlayerbiome, 2);
        ...
        for (int j = 0; j < b0; ++j)
        {
            genlayer1 = new GenLayerZoom((1000 + j), genlayer1);
        }
