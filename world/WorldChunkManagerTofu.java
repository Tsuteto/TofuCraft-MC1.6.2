...
import tsuteto.tofu.world.gen.GenLayerTofu;
...
public class WorldChunkManagerTofu extends WorldChunkManager
{
    public static ArrayList<BiomeGenTofuBase> allowedBiomes = new ArrayList<BiomeGenTofuBase>(Arrays.asList(
            BiomeGenTofuBase.tofuPlains,
            BiomeGenTofuBase.tofuForest,
            BiomeGenTofuBase.tofuBuildings,
            BiomeGenTofuBase.tofuExtremeHills));

    private GenLayerTofu genBiomes;
    ...
    {
        this();
        GenLayerTofu agenlayer = GenLayerTofu.initializeAllBiomeGenerators(seed, worldType);
    ...
    public float[] getRainfall(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
    {
        ...
        {
            float f = BiomeGenTofuBase.biomeList[aint[i1]].getIntRainfall() / 65536.0F;
    ...
    public float[] getTemperatures(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
    {
        ...
        for (int i1 = 0; i1 < par4 * par5; ++i1)
        {
            float f = BiomeGenTofuBase.biomeList[aint[i1]].getIntTemperature() / 65536.0F;
    ...
    public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5)
    {
        ...
        for (int i1 = 0; i1 < par4 * par5; ++i1)
        {
            par1ArrayOfBiomeGenBase[i1] = BiomeGenTofuBase.biomeList[aint[i1]];
        }
    ...
    public boolean areBiomesViable(int par1, int par2, int par3, List par4List)
    {
        ...
        {
            BiomeGenBase biomeGenTofuBase = BiomeGenTofuBase.biomeList[aint[j2]];
    ...
    public ChunkPosition findBiomePosition(int par1, int par2, int par3, List par4List, Random par5Random)
    {
        ...
        for (int k2 = 0; k2 < l1 * i2; ++k2)
        {
            int l2 = l + k2 % l1 << 2;
            int i3 = i1 + k2 / l1 << 2;
            BiomeGenBase biomeGenTofuBase = BiomeGenTofuBase.biomeList[aint[k2]];
