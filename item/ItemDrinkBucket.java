...
public class ItemDrinkBucket extends ItemTcBucket
{
    ...
    public ItemDrinkBucket(int par1, int par2, int healAmount, float saturationModifier)
    {
        super(par1, par2);
    ...
    public ItemStack onFoodEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.bucketEmpty));
