...
public class ItemFoodContainer extends ItemTcFood
{
    ...
    public ItemFoodContainer(int par1, int par2, float par3, boolean par4, ItemStack itemContained)
    {
        super(par1, par2, par3, par4);
        this.itemContained = itemContained;
    }
    
    public ItemFoodContainer(int par1, int par2, float par3, boolean par4)
    {
        super(par1, par2, par3, par4);
    }
