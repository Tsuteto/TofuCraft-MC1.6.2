...
public class ItemFoodSet extends ItemFoodSetBase
{
    ...
    public static TcFoodBase mabodofu =
            new Food( 2, 16, 0.5f, false, "mabodofu").setContainer(new ItemStack(Item.bowlEmpty));
    ...
    public static TcFoodBase sproutSaute =
            new Food( 7,  8, 0.4f, false, "moyashiitame").setContainer(new ItemStack(Item.bowlEmpty));
    public static TcFoodBase moyashiOhitashi =
            new Food( 8,  5, 0.3f, false, "moyashiohitashi").setContainer(new ItemStack(Item.bowlEmpty));
