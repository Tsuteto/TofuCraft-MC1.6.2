...
public class CommandTofuSlimeCheck extends CommandBase
{
    ...
    public void processCommand(ICommandSender var1, String[] var2)
    {
        ...
        if (isSpawnChunk)
        {
            var1.sendChatToPlayer(ChatMessageComponent.createFromTranslationKey("commands.tofuslimecheck.found"));
        }
        else
        {
            var1.sendChatToPlayer(ChatMessageComponent.createFromTranslationKey("commands.tofuslimecheck.notFound"));
        }
