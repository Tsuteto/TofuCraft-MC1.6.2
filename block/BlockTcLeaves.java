...
public class BlockTcLeaves extends BlockLeavesBase implements IShearable
{
    ...
    protected BlockTcLeaves(int par1)
    {
    ...
    {
        return TcBlock.tcSapling.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            if ((par5 & 8) != 0 && (par5 & 4) == 0)
            {
                ...
                {
                    this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(TcItem.apricot, 1, 0));
                }
                if (type == 2 && par1World.rand.nextInt(var8) == 0)
                {
                    int var9 = this.idDropped(par5, par1World.rand, par7);
                    this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(var9, 1, 1));
                }
            }
        }
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.icons[i] = new Icon[iconNames[i].length];
