...
public class TileEntitySaltFurnace extends TileEntity implements ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.customName : "container.tofucraft.SaltFurnace";
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.isBurning())
            {
                int blockIdAbove = this.worldObj.getBlockId(this.xCoord, this.yCoord + 1, this.zCoord);
                if (blockIdAbove == 0)
                {
                    this.worldObj.setBlock(this.xCoord, this.yCoord + 1, this.zCoord, Block.fire.blockID);
                }
                else if (blockIdAbove == Block.fire.blockID)
                {
                    this.worldObj.setBlockMetadataWithNotify(this.xCoord, this.yCoord + 1, this.zCoord, 0, 2);
                        ...
                        && this.worldObj.getBlockMaterial(this.xCoord, this.yCoord + 1, this.zCoord).getCanBurn())
                {
                    if (this.worldObj.rand.nextInt(200) == 0)
                    {
                        this.worldObj.setBlock(this.xCoord, this.yCoord + 2, this.zCoord, Block.fire.blockID);
                    }
                }
            }
        }
    ...
    private boolean canBoil()
    {
        ...
        ItemStack var1 = new ItemStack(TcItem.salt);
    ...
    public void boilDown()
    {
        if (this.canBoil())
        {
            ItemStack var1 = new ItemStack(TcItem.salt, 2);
    ...
    private boolean isCauldronOnFurnace()
    {
        ...
        return blockId == Block.cauldron.blockID;
    }
