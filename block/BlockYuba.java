...
{
    protected BlockYuba(int par1)
    {
        super(par1, TcMaterial.tofu);
    ...
    public void harvestBlock(World par1World, EntityPlayer par2EntityPlayer, int par3, int par4, int par5, int par6)
    {
        ...
        else
        {
            ...
            if (equipped != null && equipped.itemID == Item.stick.itemID)
            {
                this.dropYuba(par1World, par3, par4, par5);
            }
        }
    ...
    {
        this.dropBlockAsItem_do(par1World, par3, par4, par5, new ItemStack(TcItem.yuba));        
    }
    ...
    {
        return par3 >= 0 && par3 < 256 ? par1World.getBlockMaterial(par2, par3 - 1, par4) == Material.water : false;
    }
