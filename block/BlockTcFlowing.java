...
public class BlockTcFlowing extends BlockFluid
{
    /**
    ...
    public BlockTcFlowing(int par1, Material material, String[] iconNames)
    {
        super(par1, material);
        float var3 = 0.0F;
        float var4 = 0.0F;
    ...
    public BlockTcFlowing setColor(int color)
    {
...
//            }
        ...
        {
            if (this.blockMaterial == Material.lava && par1World.getBlockMaterial(par2, par3 - 1, par4) == TcMaterial.soymilk)
            {
